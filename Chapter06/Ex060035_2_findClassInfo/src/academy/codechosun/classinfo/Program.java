...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.printf("Package name: %s%s", vectorClass.getPackageName(), System.lineSeparator());

        System.out.printf("Type name: %s%s", vectorClass.getTypeName(), System.lineSeparator());
        ...
        System.out.printf("# declared methods: %d%s", methods.length, System.lineSeparator());
        ...
        System.out.printf("# member vars: %d%s", fields.length, System.lineSeparator());

        Class objectClass = vectorClass.getSuperclass();

        System.out.printf("Superclass: %s%s", objectClass.getTypeName(), System.lineSeparator());
    }
}