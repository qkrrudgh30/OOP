...
public class WaterSpray {
    ...
    public int getCapacity() {
        return this.bottle.capacity;
    }

    public int getRemainingWater() {
        return this.bottle.remainingWaterInMl;
    }

    public void addWater(int amountInMl) {
        this.bottle.addWater(amountInMl);
    }

    public void fillUp() {
        this.bottle.remainingWaterInMl = this.bottle.capacity;
    }

    public spray() {
        this.head.sprayFrom(this.bottle);
    }
