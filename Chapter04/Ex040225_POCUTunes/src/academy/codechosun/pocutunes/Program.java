package academy.codechosun.pocutunes;

public class Program {
    public static void main(String[] args) {
        Song hotelCalifornia = new Song("Eagles", "Hotel California", 180100);
        Song heaven = new Song("Led Zepplin", "Stairway to Heaven", 172100);
        ...
        System.out.printf("%s by %s. Playtime is %d.%s", hotelCalifornia.getName(), hotelCalifornia.getArtist(), hotelCalifornia.getPlayTimeInMilliSeconds(), System.lineSeparator());
